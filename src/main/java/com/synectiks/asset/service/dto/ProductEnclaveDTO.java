...
/**
 * A DTO for the {@link com.synectiks.asset.domain.ProductEnclave} entity.
 */
public class ProductEnclaveDTO implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ProductEnclaveDTO)) {
      return false;
    }

    ProductEnclaveDTO productEnclaveDTO = (ProductEnclaveDTO) o;
    if (this.id == null) {
      return false;
    }
    return Objects.equals(this.id, productEnclaveDTO.id);
  }
